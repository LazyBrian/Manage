    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Cashback_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Email = c.String(),
                        MerchantID = c.String(),
                        CashbackId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Cashbacks", t => t.CashbackId, cascadeDelete: true)
                .ForeignKey("dbo.Remarks", t => t.RemarkId, cascadeDelete: true)
                .Index(t => t.CashbackId)
                .Index(t => t.RemarkId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ColorTypeDesc = c.String(),
                        TransportDesc = c.String(),
                        SellerDesc = c.String(),
                        CouponDesc = c.String(),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CashbackId", "dbo.Cashbacks");
            ...
            DropIndex("dbo.Products", new[] { "CashbackId" });
